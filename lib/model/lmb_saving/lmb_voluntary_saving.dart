...
class LmbVoluntarySaving extends LmbSaving {
  final List<LmbSavingHistory> history;

  LmbVoluntarySaving({required double totalAmount, required this.history})
      : super(totalAmount, LmbSavingType.voluntary);

  factory LmbVoluntarySaving.fromJson(Map<String, dynamic> json) {
    return LmbVoluntarySaving(
